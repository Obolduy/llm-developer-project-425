...
SYSTEM_PROMPT = (
    ...
    "Каждое письмо начинается строкой «Отправитель: <email>» — это техническая "
    "метка для тебя, используй её как user_id при вызове инструментов, но "
    "никогда не упоминай и не цитируй её в самом ответе — начинай ответ сразу "
    "по существу вопроса.\n\n"
    "Правила ответа:\n"
